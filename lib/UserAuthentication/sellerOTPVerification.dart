...
class sellerOTPVerification extends StatefulWidget {
  // const registerOTPVerification({super.key});

  final String verificationId;

  sellerOTPVerification({required this.verificationId});

  @override
  State<sellerOTPVerification> createState() => _sellerOTPVerificationState();
}

class _sellerOTPVerificationState extends State<sellerOTPVerification> {
